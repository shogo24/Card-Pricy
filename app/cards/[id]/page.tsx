...
export default function CardPage() {
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      {loading && (
        <div className="flex flex-col items-center py-25 gap-4 text-ink-muted">
      ...
      {error && (
        <div className="max-w-150 mx-auto mt-15 text-center px-6">
          <h1 className="font-display text-[28px] mb-3">Card Not Found</h1>
